                                            ...
                                            <tbody id="tbodyid">
                                                 <?php
                                                        $myPDO = new PDO('mysql:host=localhost;dbname=dihubin_dih', 'dihubin_root', 'Dihroot@1');
                                                         ...
                                                         $query = $myPDO->query("SELECT * FROM astud WHERE year='4' AND ver='1' ORDER BY regno ASC");
                                                             $query->execute();
                                                ...
                                                <?php
                                                        $myPDO = new PDO('mysql:host=localhost;dbname=dihubin_dih', 'dihubin_root', 'Dihroot@1');
                                                         ...
                                                         $query = $myPDO->query("SELECT * FROM astud WHERE year='4' AND ver='0' ORDER BY regno ASC");
                                                             $query->execute();
                                                             while($row = $query->fetch(PDO::FETCH_ASSOC)){
                                                    ?>
                                                <tr class="odd gradeX">
