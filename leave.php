...
<link rel="stylesheet" type="text/css" href="css/commenters.css">
  ...
  <div class="modal-admin" >
    ...
    <input type="text" class="hidden-sm hidden-xs" id="header-search-field" placeholder="Search for Something">
             ...
             <div>
            <div class="row">
   <table class="table table-bordered" style=" border-style: solid;  border-color: grey; border-radius: 1;">
 ...
 { 
  ...
  <button type="submit" style="margin-top: 50px;" class="btn btn-primary">Send SMS</button>
      ...
      <p id = rcont style="font-weight: bold;">Templates</p> 
          ...
          <div id="insdiv" style="display: inline;width:100%;" >
   ...
   <tbody>
          ...
          <?php 
                ...
                $query = $myPDO->query("SELECT * FROM msgboard WHERE pageid='0';");
                $query->execute();
                while($row = $query->fetch(PDO::FETCH_ASSOC)){                                      
          ?>
       <tr  >
           <td style="cursor:pointer;padding: 20px;width:90%"onclick="sentmsg(this)" id="data1">
            <?php echo $row['msg']?>
           </td>
