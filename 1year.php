...
>                </ul>
                ...
                <ul class="pull-right">
                  ...
                  <table class="table" width="100%">
                    <thead><!-- universal table heading -->
                        <tr>
                            <th style="text-align:center" width="20%">Register.No</th>
                            <th style="text-align:center" width="20%">NAME</th>
                            <th style="text-align:center" width="20%">ParentsMobileNo</th>
                            <th style="text-align:center" width="20%">verify</th>
                    ...
                    <tbody id="delivery_body">
                        <?php
                                                        $myPDO = new PDO('mysql:host=localhost;dbname=dihubin_dih', 'dihubin_root', 'Dihroot@1');
                                                         $query = $myPDO->query("SELECT * FROM astud WHERE ver = 0 ORDER BY regno ASC");
                                                             $query->execute();
                                ...
                                <tr style="cell-padding:30">
                                    ...
                                    <td style="text-align:center"><?php echo $row['pno']?></td>
                                    <td style="text-align:center" onclick="veri(this)"><button type="button" class="btn btn-default" aria-label="Left Align"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span></button></td>
                                    </tr>
                        <?php
                                                             }
    ?>
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
        ...
        function veri(clicked)
            {
                var vernow = $(clicked).closest('tr').children('td:first').text().trim();
                var pass = vernow;
             var xhr = $.ajax({
            type: "POST",
            data: {id: pass},
