...
if( document.Form.password.value == "") {
  document.getElementById("pass11").innerHTML="Error: Input is empty!";
  Form.password.focus();
  return false;
}else{
  document.getElementById("pass11").style.visibility = "hidden";
}

//if( document.Form.cpassword.value == "") {
//document.getElementById("pwd2").innerHTML="Error: Input is empty!";
...
//document.getElementById("pwd2").innerHTML="Error: Password must be same!";
//Form.cpassword.focus();
//return false;
//}else{
//  document.getElementById("pwd2").style.visibility = "hidden";
