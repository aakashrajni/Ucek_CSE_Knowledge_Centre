      ...
      <fieldset>
        ...
        <div class="form-group">
          ...
          <div class="col-md-4 inputGroupContainer">
            <div class="input-group">
              ...
              <input id="regno" name="Register_no" placeholder="Register no" class="form-control"  type="text" maxlength="12" minlength="12" onkeyup="verrn()" oninput="verrn()" required / >
        ...
        <div class="form-group">
          ...
          <div class="col-md-4 inputGroupContainer">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
              <input  name="password" placeholder="Remember password to login" class="form-control"  type="text">
          ...
          <div class="col-md-4 inputGroupContainer">
            ...
            <div class="col-md-4 inputGroupContainer">
              <div class="input-group">
                ...
                <input  name="address" placeholder="Address For communiation" id="address" class="form-control"  type="text" onkeyup="addres()">
...
<!-- p_ addresss-->
            ...
            <div class="col-md-4 inputGroupContainer">
              <div class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
                <input  name="p_address" placeholder="Permanent Address" id="paddress" class="form-control"  type="textarea">
...
<script>
    function addres(){
        ...
        document.getElementById("paddress").value = add;
    }
function verrn()
    {
        ...
        if(len == 12)
        {
            ...
            success: function(data){
                if(data != 0)
                {
                    document.getElementById("Register_no1").innerHTML = "Register No Already Exist";
                }
            }
                      });
        }
        if(len < 12)
            document.getElementById("Register_no1").innerHTML = "";
    }
</script>
</html>
