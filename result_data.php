...
<link rel="stylesheet" type="text/css" href="plugin/dropzone-master/dist/dropzone.css">
    ...
    <input type="text" class="hidden-sm hidden-xs" id="header-search-field" placeholder="Search for Something">
              ...
              <div class="col-md-7">
                <ul class="pull-right">
                  ...
                  <div style="margin-top: 50px;margin-left: 50px;margin-right: 50px;" id="dz" class="dropzone">
<!--
...
-->
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
        ...
        <script src="plugin/dropzone-master/dist/dropzone.js"></script>
    ...
    var myDropzone = new Dropzone("#dz", { url: "/smsd/upload.php"});
